...
<?php
	    ...
	    $query2="   SELECT * FROM `jobs`  WHERE type_job = 'DEVELOPMENT' AND validity = 'Available' ORDER BY id DESC";
...
<div class="inputbox">
    ...
    <datalist id="jobs">
        <option value="programs Developer">programs Developer</option>
        ...
        <option value="it projects manager">it projects manager</option>
